...
procedure Window (x1, y1, x2, y2: Integer); external name 'crt_Window';
...
var
  ...
  CursorShapeHidden: Integer = 0; attribute (name = 'crt_CursorShapeHidden');
  CursorShapeNormal: Integer = 1; attribute (name = 'crt_CursorShapeNormal');
  CursorShapeFull:   Integer = 2; attribute (name = 'crt_CursorShapeFull');
...
var
  ...
  VirtualShiftState: Integer = 0; attribute (name = 'crt_VirtualShiftState');
...
procedure SetScreenSize (x, y: Integer); external name 'crt_SetScreenSize';
...
procedure GetWindow (var x1, y1, x2, y2: Integer); external name 'crt_GetWindow';
...
procedure WriteCharAttrAt (x, y, Count: Integer; CharAttr: PCharAttrs); external name 'crt_WriteCharAttrAt';

{ Write a char while moving the cursor }
procedure WriteChar (ch: Char);

{ Read a character from a screen position }
procedure ReadChar (x, y: Integer; var ch: Char; var Attr: TTextAttr); external name 'crt_ReadChar';
...
procedure PanelNew                 (x1, y1, x2, y2: Integer; BindToBackground: Boolean); external name 'crt_PanelNew';
...
function  CRT_Get_Input_FD: Integer; external name 'crt_Get_Input_FD';
function  CRT_Get_Output_FD: Integer; external name 'crt_Get_Output_FD';
...
var
  ...
  CRTInputFD   : Integer = -1;      attribute (name = 'crt_InputFD');
  CRTOutputFD  : Integer = -1;      attribute (name = 'crt_OutputFD');
...
{$ifdef USE_NCURSES}
procedure CRT_DoTextModeCommand (Columns, Lines: Integer); attribute (name = 'crt_DoTextModeCommand');
var
  CommandLine: CString;
  Buffer: TString;
  Blocked: Boolean;
...
begin
  ...
  Signaled := False;
  Dummy := ExecuteNoTerminal (Buffer);
...
procedure CRT_Fatal (Reason: Integer); attribute (noreturn, name = 'crt_Fatal');
begin
  case Reason of
