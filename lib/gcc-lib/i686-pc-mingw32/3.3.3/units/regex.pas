...
function  RegExPosFrom (const Expression: String; ExtendedRegEx, CaseInsensitive: Boolean; const s: String; From: Integer): Integer; attribute (name = '_p_RegExPosFrom');
...
procedure GetMatchRegEx (var RegEx: RegExType; n: Integer; var MatchPosition, MatchLength: Integer); external name '_p_GetMatchRegEx';
...
function  ReplaceSubExpressionReferences (var RegEx: RegExType; const s, ReplaceStr: String): TString; attribute (name = '_p_ReplaceSubExpressionReferences');
...
function  CharSet2RegEx (const Characters: CharSet): TString; attribute (name = '_p_CharSet2RegEx');

implementation

{$L rx, regexc.c}

procedure CNewRegEx (var RegEx: RegExType; Expression: CString; ExpressionLength: Integer; ExtendedRegEx, CaseInsensitive, NewLines: Boolean); external name '_p_CNewRegEx';
function CMatchRegExFrom (var RegEx: RegExType; aString: CString; StrLength: Integer; NotBeginningOfLine, NotEndOfLine: Boolean; From: Integer): Boolean; external name '_p_CMatchRegExFrom';
