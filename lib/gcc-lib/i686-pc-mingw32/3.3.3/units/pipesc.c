...
GLOBAL (int _p_CPipe (char *path, char *argv[], char *envp[], char *name_stdin, char *name_stdout, char *name_stderr, void (*ChildProc) ()))
{
...
static char * const *fix_argv (char **argvec);
static char * const *
fix_argv (argvec)
     char **argvec;
{
