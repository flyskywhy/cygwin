...
function CSetLocale (Category: Integer; Locale: CString): CString; external name '_p_CSetLocale';
...
function CDCGetText (DomainName, MsgId: CString; Category: Integer): CString; external name '_p_CDCGetText';
