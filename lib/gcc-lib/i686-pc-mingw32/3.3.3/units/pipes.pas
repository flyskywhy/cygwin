...
function CPipe (Path: CString; CProcessParameters, ProcessEnvironment: PCStrings; PPipeStdIn, PPipeStdOut, PPipeStdErr: PInteger; ChildProc: TProcedure): Integer; external name '_p_CPipe';
...
function CPipe (Path: CString; CProcessParameters, ProcessEnvironment: PCStrings; NameStdIn, NameStdOut, NameStdErr: CString; ChildProc: TProcedure): Integer; external name '_p_CPipe';
...
function PExecuteC (ProgramName: CString; ArgV: PCStrings; This_PName, Temp_Base: CString;
                    var ErrMsg_Fmt, ErrMsg_Arg: CString; Flags: Integer): Integer; external name 'pexecute';
function PWaitC (PID: Integer; var Status: Integer; Flags: Integer): Integer; external name 'pwait';
