...
{ This function is meant to be used when you want to invoke a system
  ...
  &> file            redirect both standard output and standard
                     error to file }
function  TranslateRedirections (const Command: String): TString; attribute (name = '_p_TranslateRedirections');
...
function  OEM2Latin1Str (const s: String): TString; attribute (name = '_p_OEM2Latin1Str');
...
function  Latin12OEMStr (const s: String): TString; attribute (name = '_p_Latin12OEMStr');
