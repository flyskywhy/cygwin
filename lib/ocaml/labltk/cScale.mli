...
val configure : (* scale *) widget -> (* scale *) options list -> unit 

val configure_get : (* scale *) widget -> string 

val coords : (* scale *) widget -> int * int 

val coords_at : (* scale *) widget -> float -> int * int 

val get : (* scale *) widget -> float 

val get_xy : (* scale *) widget -> int -> int -> float 
