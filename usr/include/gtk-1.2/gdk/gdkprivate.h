...
extern GDK_IMPORT gint		 gdk_debug_level;
extern GDK_IMPORT gint		 gdk_show_events;
extern GDK_IMPORT gint		 gdk_use_xshm;
extern GDK_IMPORT gint		 gdk_stack_trace;
extern GDK_IMPORT gchar		*gdk_display_name;
extern GDK_IMPORT Display		*gdk_display;
extern GDK_IMPORT gint		 gdk_screen;
extern GDK_IMPORT Window		 gdk_root_window;
extern GDK_IMPORT Window		 gdk_leader_window;
extern GDK_IMPORT GdkWindowPrivate	 gdk_root_parent;
extern GDK_IMPORT Atom		 gdk_wm_delete_window;
extern GDK_IMPORT Atom		 gdk_wm_take_focus;
extern GDK_IMPORT Atom		 gdk_wm_protocols;
extern GDK_IMPORT Atom		 gdk_wm_window_protocols[];
extern GDK_IMPORT Atom		 gdk_selection_property;
extern GDK_IMPORT GdkDndGlobals	 gdk_dnd;
extern GDK_IMPORT GdkWindow	*selection_owner[];
extern GDK_IMPORT gchar		*gdk_progclass;
extern GDK_IMPORT gint		 gdk_error_code;
extern GDK_IMPORT gint		 gdk_error_warnings;
extern GDK_IMPORT gint              gdk_null_window_warnings;
extern GDK_IMPORT GList            *gdk_default_filters;
extern GDK_IMPORT const int         gdk_nevent_masks;
extern GDK_IMPORT const int         gdk_event_mask_table[];

extern GDK_IMPORT GdkWindowPrivate *gdk_xgrab_window;  /* Window that currently holds the
					     * x pointer grab
					     */
...
extern GDK_IMPORT GdkICPrivate *gdk_xim_ic;		/* currently using IC */
extern GDK_IMPORT GdkWindow *gdk_xim_window;	        /* currently using Window */
#endif /* USE_XIM */
...
extern GDK_IMPORT guint gdk_debug_flags;
