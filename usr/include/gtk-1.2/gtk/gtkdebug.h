...
#ifndef GTK_IMPORT
#if (defined(_WIN32) || defined(__CYGWIN__)) && !(defined(GTK_BUILD_DLL) || defined(GTK_STATIC))
#define GTK_IMPORT __declspec(dllimport)
#else
#define GTK_IMPORT
#endif
#endif
...
extern GTK_IMPORT guint gtk_debug_flags;
