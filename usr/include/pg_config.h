...
#define PACKAGE_STRING "PostgreSQL 8.2.9"
...
#define PG_VERSION "8.2.9"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 80209

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 8.2.9 on i686-pc-cygwin, compiled by GCC gcc (GCC) 3.4.4 (cygming special, gdc 0.12, using dmd 0.125)"
