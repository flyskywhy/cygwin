...
version (GNU)
{
    ...
    alias gcc.config.EOF EOF;
    alias gcc.config.FOPEN_MAX FOPEN_MAX;
...
{
    FILE * _d_gnu_cbridge_stdin;
    FILE * _d_gnu_cbridge_stdout;
    FILE * _d_gnu_cbridge_stderr;
...
else version (darwin)
{
    ...
    {
	static assert(gcc.config.FILE_struct_size != 0);
	FILE __sF[3];
...
{
   alias gcc.config.ferror ferror;
   alias gcc.config.feof feof;
   alias gcc.config.clearerr clearerr;
   alias gcc.config.rewind rewind;
   alias gcc.config._bufsize _bufsize;
   alias gcc.config.fileno fileno;
   alias gcc.config.Csnprintf snprintf;
   alias gcc.config.Cvsnprintf vsnprintf;
   alias gcc.config.Csnprintf _snprintf;
