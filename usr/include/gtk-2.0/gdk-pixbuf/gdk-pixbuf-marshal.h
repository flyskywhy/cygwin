...
/* VOID:VOID (/instsoft/gnome/platform/gtk+-2.6.10/gdk-pixbuf/gdk-pixbuf-marshal.list:25) */
#define _gdk_pixbuf_marshal_VOID__VOID	g_cclosure_marshal_VOID__VOID

/* VOID:INT,INT,INT,INT (/instsoft/gnome/platform/gtk+-2.6.10/gdk-pixbuf/gdk-pixbuf-marshal.list:26) */
...
/* VOID:POINTER (/instsoft/gnome/platform/gtk+-2.6.10/gdk-pixbuf/gdk-pixbuf-marshal.list:27) */
#define _gdk_pixbuf_marshal_VOID__POINTER	g_cclosure_marshal_VOID__POINTER

/* VOID:INT,INT (/instsoft/gnome/platform/gtk+-2.6.10/gdk-pixbuf/gdk-pixbuf-marshal.list:28) */
