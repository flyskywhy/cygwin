...
int main(int argc, char **argv) {
  { foo_window = new Fl_Double_Window(642, 337, "Comparison of Fl_Tab (left) vs. Fl_Wizard (right)");
    { Fl_Box* o = new Fl_Box(95, 5, 130, 30, "class Fl_Tabs");
      o->labeltype(FL_ENGRAVED_LABEL);
      o->labelfont(1);
    } // Fl_Box* o
    { Fl_Tabs* o = new Fl_Tabs(10, 40, 300, 200);
      o->tooltip("the various index cards test different aspects of the Fl_Tabs widget");
      o->selection_color((Fl_Color)4);
      o->labelcolor(FL_BACKGROUND2_COLOR);
      { Fl_Group* o = new Fl_Group(10, 60, 300, 180, "Label1");
      ...
      { Fl_Group* o = new Fl_Group(10, 60, 300, 180, "tab2");
      ...
      { Fl_Group* o = new Fl_Group(10, 60, 300, 180, "tab3");
...
ry similar");
      ...
      { Fl_Group* o = new Fl_Group(10, 60, 300, 180, "     tab5      ");
...
indow is iconized");
    ...
    { Fl_Box* o = new Fl_Box(410, 5, 130, 30, "class Fl_Wizard");
      o->labeltype(FL_ENGRAVED_LABEL);
      o->labelfont(1);
    } // Fl_Box* o
