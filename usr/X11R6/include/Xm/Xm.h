/**
 *
 * $Header: /cvsroot/lesstif/lesstif/include/Motif-2.1/Xm/Xm.h.in,v 1.37 2005/03/26 19:26:52 dannybackx Exp $
 *
...
#define LESSTIF_REVISION 94
#define	LESSTIF_UPDATE_LEVEL	4

#define LesstifVersion (LESSTIF_VERSION * 1000 + LESSTIF_REVISION)
#define LesstifVERSION_STRING "@(#)GNU/LessTif Version 2.1 Release 0.94.4"
...
typedef struct __XmParseMappingRec *XmParseMapping;     /* Definition hidden in source */
